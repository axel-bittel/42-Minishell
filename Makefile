...
%.o: %.c 
	gcc -Wall -Werror -Wextra -c -I ~/.brew/opt/readline/include -I./include -I./libft -o $@ $< -g
${NAME_S} :	${OSRCS} libft/libft.a 
	gcc ${OSRCS} -Llibft -L ~/.brew/opt/readline/lib -lft -lreadline -lncurses -o ${NAME_S} -g

debug:
	gcc -g -o debug  -I ~/.brew/opt/readline/include -I./include -I./libft $(SRCS) -Llibft -L ~/.brew/opt/readline/lib -lft -lreadline -lncurses -fsanitize=address
